...
//	for (i = 0; i <= nr; i++) {
//		nrv= 0;
//		(angajati + i)->nume[0] = tolower((angajati + i)->nume[0]);
//		for (j = 0; j < strlen((angajati + i)->nume); j++) {
//			/*if (strchr("aeiouAEIOU", (angajati + i)->nume[j]) != 0) {
//				nrv++;
//			}*/
//			
//			if ((angajati + i)->nume[j] == 'a' || (angajati + i)->nume[j] == 'e' || (angajati + i)->nume[j] == 'i' || (angajati + i)->nume[j] == 'o' || (angajati + i)->nume[j] == 'u')
//				nrv++;
//			
//		}
//
//		(angajati + i)->nume[0] = toupper((angajati + i)->nume[0]);
//		if (nrv > 2) {
